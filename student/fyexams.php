<?php
    ...
    $name = $_SESSION['name'];
    $sql = "SELECT * FROM fyexams WHERE name = '$name'";
						...
						<div class="card-body">
							<table class="table table-hover">
									<tbody>
										...
										<tr>
											<th>Mid-Sem</th>
											<td><?php echo $res['mid_PPS']?></td>
											<td><?php echo $res['mid_ACH']?></td>
										</tr>

										
										<tr>
											<th>End-Sem</th>
											<td><?php echo $res['end_PPS']?></td>
											<td><?php echo $res['end_ACH']?></td>
										</tr>

										<tr>
											<th>Total</th>
											<td><?php echo $res['mid_PPS']+$res['end_PPS']?></td>
											<td><?php echo $res['mid_ACH']+$res['end_ACH']?></td>
										</tr>
