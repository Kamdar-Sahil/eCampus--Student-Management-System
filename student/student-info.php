				...
				<div class="col-lg-12 m-b30">
					<div class="widget-box">
						...
						<div class="card text-center">
							...
							<div class="card-body">
								<h5 class="card-title">Full Name :- <?php echo $res['name'] ?></h5>
								<h5 class="card-title">Gender :- <?php echo $res['gender'] ?></h5>
								<h5 class="card-title">Email :- <?php echo $res['email'] ?></h5>
								<h5 class="card-title">Phone No. :- <?php echo $res['contact_number'] ?></h5>
								<h5 class="card-title">Date of Birth :- <?php echo $res['dob'] ?></h5>
								<h5 class="card-title">Address :- <?php echo $res['address'] ?></h5>
							</div>
						</div>
						...
						<div class="card text-center">
							...
							<div class="card-body">
								<h5 class="card-title">Roll No. :- <?php echo $res['roll'] ?></h5>
								<h5 class="card-title">Year of Study :- <?php echo $res['year'] ?></h5>
								<h5 class="card-title">Branch of Study :- <?php echo $res['branch'] ?></h5>
							</div>
						</div>
						<div class="seperator"></div>
