...
<br>
  ...
  <div class="col-md-4">
    ...
    <input name = "dob" type="date" class="form-control" id="inputDoB" placeholder = "Birth Date">
  </div>
  ...
  <div class="col-md-6">
    ...
    <input name = "contact" type="digits" class="form-control" id="inputContact" placeholder = "Contact Number">
  </div>
  <br>
  <div class="col-md-6">
		<label for="inputGender" class="form-label">Gender</label>
		<input name = "gender" type="text" class="form-control" id="inputGender" placeholder="Gender">
  </div>
  <br>
  <div class="col-md-6">
...
$gender=$_POST['gender'];
$pass=$_POST['password'];
$result=mysqli_query($mysqli,"INSERT into record_student values('','$name','$gender','$email','$contact','$dob','$address','$roll','$year','$branch','$pass')");
