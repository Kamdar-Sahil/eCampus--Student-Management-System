				...
				<ul>
					...
					<li>
		                ...
		                <ul>
		                	...
		                	<li>
		                		<a href="lrctures.php" class="ttr-material-button"><span class="ttr-label">Lectures</span></a>
		                	</li>
...
<br>
<h4 class="breadcrumb-title">First Year</h4>
...
<tbody>
	<?php
$result=mysqli_query($mysqli,"SELECT* from record_student WHERE year = 'First Year'");
...
<tbody>
  <?php
 $result=mysqli_query($mysqli,"SELECT* from record_student WHERE year = 'Second Year'");
...
<tbody>
  <?php
 $result=mysqli_query($mysqli,"SELECT* from record_student WHERE year = 'Third Year'");
...
<tbody>
  <?php
 $result=mysqli_query($mysqli,"SELECT* from record_student WHERE year = 'Final Year'");
