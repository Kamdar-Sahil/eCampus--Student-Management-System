...
<br>
    ...
    <table class="table table-hover">
           <tbody>
             <thead>
              ...
              <td>
                  <input  type="digits" name="PPSmidsem" placeholder = "Mid-Sem Marks">
              </td>

              <td>
                  <input type="digits" name="ACHmidsem" placeholder = "Mid-Sem Marks" >
              </td>
              ...
              <td>
                  <input type="digits" name="PPSendsem" placeholder = "End-Sem Marks">
              </td>

              <td>
                  <input type="digits" name="ACHendsem" placeholder = "End-Sem Marks" >
              </td>
 ...
 <input type="submit" name="submit">
		 ...
		 $name=$_POST['name'];
		 $roll=$_POST['roll'];
		 $mid_PPS=$_POST['PPSmidsem'];
		$mid_ACH=$_POST['ACHmidsem'];
		$end_PPS=$_POST['PPSendsem'];
	 $end_ACH=$_POST['ACHendsem'];
	 

		 $result=mysqli_query($mysqli,"INSERT into fyexams values('','$name','$roll','$mid_PPS','$mid_ACH','$end_PPS','$end_ACH')");
   ...
   <div class="card-body">
     <table class="table table-hover">
            <tbody>
              ...
              <tbody>
<?php $result1=mysqli_query($mysqli,"SELECT* from fyexams ORDER by id DESC");
...
echo '<tr>';
                  ...
                  echo '<tr>';
                    echo '<th>'.'Mid-Sem'.'</th>' ;
                    echo '<td>'. $res['mid_PPS'].' </td>';
                    echo '<td>'. $res['mid_ACH'].' </td>';

                  echo '</tr>';
									echo '<tr>';
										echo '<th>'.'End-Sem'.'</th>' ;
										echo '<td>'. $res['end_PPS'].' </td>';
										echo '<td>'. $res['end_ACH'].' </td>';
